...
Location.create!({
  ...
  url: "https://api.weather.gov/gridpoints/BOU/48,73/forecast"
})
...
Location.create!({
  ...
  url: "https://api.weather.gov/gridpoints/BOU/69,43/forecast"
})
...
Location.create!({
  ...
  url: "https://api.weather.gov/gridpoints/BOU/52,70/forecast"
})
...
Location.create!({
  ...
  url: "https://api.weather.gov/gridpoints/BOU/41,88/forecast"
})
